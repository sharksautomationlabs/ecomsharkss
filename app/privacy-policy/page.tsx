...
export default function PrivacyPolicyPage() {
  ...
  return (
    <>
      ...
      <div className="w-full bg-[#03101e] min-h-screen">
        <Header
      ...
      <section ref={ref} className="w-full bg-[#03101e] py-16 lg:py-24 relative z-10">
        <div className="container mx-auto px-5 lg:px-20">
          ...
          >
            <motion.div variants={textVariants} className="bg-[rgba(10,48,80,0.45)] backdrop-blur-sm rounded-2xl lg:rounded-3xl shadow-2xl p-8 lg:p-12 border border-[#35c4dd]/20 relative z-20 opacity-100">
              
              {/* Last Updated */}
              <motion.div variants={textVariants} className="mb-8">
                <p className="text-sm text-[#9dc3d4]" style={{ fontFamily: "'Barlow', sans-serif" }}>
              ...
              {/* Introduction */}
              <motion.div variants={textVariants} className="mb-8">
                <h2 className="text-2xl lg:text-3xl font-bold text-[#35c4dd] mb-4" style={{ fontFamily: "'Barlow Condensed', sans-serif" }}>
                  Introduction
                </h2>
                <p className="text-base lg:text-lg text-[#9dc3d4] leading-relaxed" style={{ fontFamily: "'Barlow', sans-serif" }}>
              ...
              <motion.div variants={textVariants} className="mb-8">
                ...
                <div className="space-y-4">
                  <div>
                    <h3 className="text-xl font-semibold text-[#35c4dd] mb-2" style={{ fontFamily: "'Barlow', sans-serif" }}>
                      Personal Information
                    </h3>
                    <p className="text-base lg:text-lg text-[#9dc3d4] leading-relaxed" style={{ fontFamily: "'Barlow', sans-serif" }}>
                      We may collect personal information that you voluntarily provide to us, including:
                    </p>
                    <ul className="list-disc list-inside mt-2 space-y-1 text-[#9dc3d4]" style={{ fontFamily: "'Barlow', sans-serif" }}>
              ...
              <motion.div variants={textVariants} className="mb-8">
                ...
                <p className="text-base lg:text-lg text-[#9dc3d4] leading-relaxed mb-4" style={{ fontFamily: "'Barlow', sans-serif" }}>
                  We use the information we collect to:
                </p>
                <ul className="list-disc list-inside space-y-2 text-[#9dc3d4]" style={{ fontFamily: "'Barlow', sans-serif" }}>
              ...
              <motion.div variants={textVariants} className="mb-8">
                ...
                <div className="bg-[#f8fafc] rounded-lg p-6" style={{ fontFamily: "'Barlow', sans-serif" }}>
                  <p className="text-[#9dc3d4] mb-2"><strong>Email:</strong> info@ecomsharksofficial.com</p>
                  <p className="text-[#9dc3d4]"><strong>Phone:</strong> (713) 337-7701</p>
                </div>
              </motion.div>
