    ...
    <div className="w-full bg-[#052126] flex justify-center">
      ...
      <div className="relative w-full max-w-[1920px] aspect-[1920/1000] overflow-hidden select-none">
        ...
        <div className="relative z-20 w-full h-full">
          ...
          {/* Hero Text Content - CUSTOMIZED FOR TIKTOK */}
          ...
          {/* Visual Elements Layer - ONLY TIKTOK LOGO */}
          <div className="absolute inset-0 z-30">
            ...
            {/* TikTok Logo - Only logo shown as requested */}
            <div className="absolute top-[44%] right-[20%] w-[16%] h-auto z-40 logo-fade-in-tiktok">
                <Image src={img91} alt="TikTok Logo" width={310} height={310} objectFit="contain" />
            </div>
          </div>
        </div>
      </div>
