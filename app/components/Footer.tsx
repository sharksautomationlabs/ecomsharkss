...
import HomeFooter from '../home2/components/Footer';
  ...
  return (
    <footer ref={ref} className="relative w-full -pt-8 lg:pt-24 overflow-x-hidden">
      ...
      <div className="absolute inset-0 z-0">
        <div className="absolute inset-0 bg-gradient-to-b from-[#0b2237] to-[#03101e]" />
        <div 
      ...
      >
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-x-16 gap-y-12">
          ...
          <motion.div
            className="pt-8 lg:pt-12 text-[#eaf7fb]"
            ...
            <div className="mt-8 lg:mt-12 space-y-4 lg:space-y-6">
              <div className="flex items-center gap-3 lg:gap-4">
                ...
                <div>
                  ...
                  <p className="text-base lg:text-lg">info@ecomsharksofficial.com</p>
                </div>
              </div>
              <div className="flex items-center gap-3 lg:gap-4">
                <PhoneIcon />
                <div>
                  ...
                  <p className="text-base lg:text-lg">(713) 337-7701</p>
                </div>
              </div>
            </div>
          </motion.div>
      ...
      {/* Bottom footer bar — same component as the homepage footer */}
