...
// Service data with Shopify-specific content
const servicesData = [
  {
    id: 1,
...
export default function ShopifyBestServices() {
  ...
  return (
    <div ref={ref} className="relative z-[2] w-full py-16 lg:py-24">
      <div className="container mx-auto px-5 lg:px-20 text-white">
        ...
        >
          {servicesData.map((service, index) => (
            ...
            >
              ...
              {/* Service Description */}
              <p
                className="text-[#9dc3d4] leading-relaxed flex-grow text-sm lg:text-base"
                style={{ fontFamily: "'Barlow', sans-serif" }}
              >
                {service.description}
              </p>
        ...
        {/* Bottom CTA Buttons */}
        <motion.div
          className="flex flex-col sm:flex-row justify-center items-center gap-4 lg:gap-6 mt-12 lg:mt-20"
          variants={headerVariants}
          initial="hidden"
          animate={controls}
        >
