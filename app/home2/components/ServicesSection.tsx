    ...
    <section id="services" className="px-[6%] py-28">
      <motion.div ref={ref} variants={staggerContainer} initial="hidden" animate={controls} className="mx-auto mb-16 max-w-[820px] text-center">
        ...
        <motion.p variants={fadeUp} className="mt-4 text-[1.05rem] text-[#9dc3d4]">
          One team. Four platforms. Complete automation from product research to fulfillment.
        </motion.p>
      </motion.div>
      ...
      >
        {services.map((s) => (
          <motion.div
            ...
            variants={fadeUp}
            {...tilt}
            className="rounded-[22px] border border-[#35c4dd]/[0.22] bg-[rgba(10,48,80,0.45)] p-8 backdrop-blur-sm transition-[transform,box-shadow] duration-150 hover:shadow-[0_26px_60px_rgba(0,0,0,.55),0_0_30px_rgba(53,196,221,.12)]"
          >
