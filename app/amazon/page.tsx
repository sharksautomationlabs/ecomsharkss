...
const amazonTestimonials = [
  {
    ...
    review: "Aain ali helped us launch our first Amazon FBA product and we hit $50K in sales within 3 months! Their automation services for inventory management and PPC optimization are incredible. We went from struggling to profitable in record time.",
    rating: 5,
  ...
  },
  {
    ...
    review: "The Amazon FBA automation services from Aain ali are phenomenal. They handled everything from product research to listing optimization. Our sales increased by 400% and we're now ranking on page 1 for our main keywords. Highly recommend!",
    rating: 5,
    postDate: "Dec 8, 2024",
  ...
  },
  {
    ...
    review: "Working with Aain ali for our Amazon FBA business has been transformative. Their automation tools for inventory forecasting and repricing saved us from stockouts and helped us maintain competitive pricing. Revenue grew 250% in 6 months!",
    rating: 4,
  ...
  return (
    <div className="w-full bg-white overflow-x-hidden">
      ...
      <Mission 
        ...
        customTitle="Amazon FBA automation for brands that want scale without chaos"
