...
const shopifyTestimonials = [
  {
    ...
    review: "Aain ali transformed our Shopify store with their automation services. They set up dropshipping automation, optimized our checkout process, and implemented advanced analytics. Our conversion rate increased by 180% and we're now doing $75K monthly revenue!",
    rating: 5,
    postDate: "Jan 5, 2025",
  ...
  },
  {
    ...
    review: "The Shopify automation services from Aain ali are outstanding. They automated our inventory management, customer service, and marketing campaigns. We went from manual processes to a fully automated store that runs 24/7. Sales tripled in 4 months!",
    rating: 4,
  ...
  },
  {
    ...
    review: "Working with Aain ali for our Shopify automation has been incredible. They implemented advanced product sourcing, automated order fulfillment, and set up dynamic pricing. Our profit margins improved by 150% and we're scaling faster than ever before!",
    rating: 5,
