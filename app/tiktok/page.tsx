...
const tiktokTestimonials = [
  {
    ...
    review: "Aain ali TikTok automation services are game-changing! They helped us grow from 1K to 500K followers in just 6 months. Their content strategy and posting automation increased our engagement by 300%. Our brand visibility skyrocketed!",
    rating: 4,
  ...
  },
  {
    ...
    review: "The TikTok automation from Aain ali transformed our social media presence. They automated our content creation, posting schedule, and audience engagement. Our reach increased by 400% and we're now generating consistent leads for our business!",
    rating: 5,
  ...
  },
  {
    ...
    review: "Working with Aain ali for TikTok automation has been incredible. They set up advanced targeting, automated our ad campaigns, and optimized our content for maximum viral potential. Our conversion rate improved by 250% and we're dominating our niche!",
    rating: 5,
  ...
  return (
    <div className="w-full bg-white overflow-x-hidden">
      ...
      <Mission 
        ...
        customTitle="TikTok Shop campaigns that connect content to real revenue"
